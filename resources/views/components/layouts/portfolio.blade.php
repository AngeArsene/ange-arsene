    ...
    <main class="min-h-screen md:pl-[var(--rail-width)]">
        ...
        <footer class="mx-auto max-w-7xl px-6 pb-24 pt-24 sm:px-10 lg:px-16">
            <div class="border-t border-white/10 pt-8">
                ...
                <div class="mt-5 flex flex-wrap items-center justify-between gap-4 text-xs uppercase tracking-[0.18em] text-faint"><span>© {{ date('Y') }} Ange Arsène</span><span>Douala · Cameroon</span></div>
            </div>
        </footer>
    </main>
